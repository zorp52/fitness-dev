...
func DevDisplayGeneratedData(workouts []models.Workout) {
...
func InsertMockData(db *sql.DB) {
	...
	// Declare a slice to store generated workouts
	...
	DevDisplayGeneratedData(workouts) // Now workouts is defined and passed correctly
}
